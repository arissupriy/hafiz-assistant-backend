...
typedef FreeSearchResultsNative = Void Function(Pointer<AyahDataNative> results, Uint64 count);
typedef FreeSearchResults = void Function(Pointer<AyahDataNative> results, int count);
...
class HafizAssistantFFI {
  ...
  bool initialize() {
    ...
    try {
      ...
      // Load function pointers with correct names
      ...
      print('FFI initialized: $_isInitialized');
