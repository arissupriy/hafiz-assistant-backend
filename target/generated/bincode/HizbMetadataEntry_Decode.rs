impl < __Context > :: bincode :: Decode < __Context > for HizbMetadataEntry
{
    ...
    error :: DecodeError >
    {
        ...
        Ok(Self
        {
            hizb_number : :: bincode :: Decode :: decode(decoder) ?,
...
for HizbMetadataEntry
{
    ...
    Self, :: bincode :: error :: DecodeError >
    {
        ...
        Ok(Self
        {
            hizb_number : :: bincode :: BorrowDecode ::< '_, __Context >::
