impl < __Context > :: bincode :: Decode < __Context > for RubMetadataEntry
{
    ...
    error :: DecodeError >
    {
        ...
        Ok(Self
        {
            rub_number : :: bincode :: Decode :: decode(decoder) ?,
...
for RubMetadataEntry
{
    ...
    Self, :: bincode :: error :: DecodeError >
    {
        ...
        Ok(Self
        {
            rub_number : :: bincode :: BorrowDecode ::< '_, __Context >::
