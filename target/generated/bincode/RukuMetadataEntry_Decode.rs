impl < __Context > :: bincode :: Decode < __Context > for RukuMetadataEntry
{
    ...
    error :: DecodeError >
    {
        ...
        Ok(Self
        {
            ruku_number : :: bincode :: Decode :: decode(decoder) ?,
...
for RukuMetadataEntry
{
    ...
    Self, :: bincode :: error :: DecodeError >
    {
        ...
        Ok(Self
        {
            ruku_number : :: bincode :: BorrowDecode ::< '_, __Context >::
